...
independent review. The implementation-plan candidate authorizes no
implementation: Canonical Dataset remains NOT IMPLEMENTED / NOT AUTHORIZED,
and it does not authorize canonical availability or Replay activation,
production Recorder deployment, or production `CLOCK_SAFETY` closure.
